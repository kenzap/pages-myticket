...
/**
 * @name PassPicker
 * @description This class is responsible for variable price selection. 
 * Price variations are defined in https://myticket.kenzap.cloud/layout-list/
...
export class PassPicker{
    ...
    constructor(parent){
		...
		this.parent = parent; // parent variables
		this.state = parent.state; // layout settings data
		this.data = parent.data; // current zone id
